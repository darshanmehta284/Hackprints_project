...
$result1 = $obj->query("select city.id,city.city,state.state_name from city inner join state on city.state_id=state.state_id");
        ...
        <div id="content">
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile min" align="align-self-center">
                    <h4 class="tittle-w3-agileits mb-2">All Cities</h4>
                    <table class="table" align="center">
                        ...
                        <tbody>
                            ...
                            <td><a href="edit_city.php?editid=<?php echo $row->id;?>">Edit</a></td>
                            <td><a href="delete_city.php?delid=<?php echo $row->id;?>">Delete</a></td>
