...
if(isset($_POST['submit']))
{
    ...
    $result = $obj->query("select * from user where email='$email'");
    $rowcount = $result->num_rows;

    $result1 = $obj->query("select * from user where contact='$contact'");
    $rowcount1 = $result->num_rows;
    ...
    else if($password==$cpassword)
    {
        ...
        $exe =$obj->query("insert into user(fname,lname,email,contact,address,password) values('$fname','$lname','$email','$contact','$address','$password')");
                            ...
                            <div class="contact-form">
                                <form method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form_group">
                                                <input type="text" class="form_control" placeholder="contact" name="contact" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form_group">
                                                <textarea class="form_control" placeholder="Your Address" name="address"></textarea>
                                            </div>
                                        </div>
                                         <div class="col-lg-12">
                                            <div class="form_group">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form_group">
                                                <button class="main-btn" name="submit">Register</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
