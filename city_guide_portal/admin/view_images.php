...
$p = $obj->query("select images.id,images.place_id,images.image,place.place from images inner join place on images.place_id=place.id where place.id='$ide'");
        ...
        <div id="content">
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile min" align="align-self-center">
                    <h4 class="tittle-w3-agileits mb-2">All Images</h4>
                    <a href="more_image.php?placeid=<?php echo $_GET['imageid'];?>" class="btn btn-danger" style="float: right" >Add New Images</a>
                    <br/><br/>
                    <table class="table" align="center">
                        ...
                        <tbody>
                            ...
                            <td><img src="upload/<?php echo $row->image;?>" height="200" width="300"></td>
                            <td><a href="edit_image.php?editid=<?php echo $row->id;?>">Edit</a></td>
                            <td><a href="delete_image.php?delid=<?php echo $row->id;?>">Delete</a></td>
