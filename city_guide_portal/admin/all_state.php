        ...
        <div id="content">
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile min" align="align-self-center">
                    <h4 class="tittle-w3-agileits mb-2">All states</h4>
                    <table class="table" align="center">
                        ...
                        <tbody>
                            ...
                            <td><a href="edit_state.php?editid=<?php echo $row->state_id;?>">Edit</a></td>
                            <td><a href="delete_state.php?delid=<?php echo $row->state_id;?>">Delete</a></td>
