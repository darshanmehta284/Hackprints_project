...
$result1=$obj->query("select * from state");

if(isset($_POST['submit']))
{
     $city=$_POST["city"];
     $state=$_POST["state"];
     // echo "insert into city(city,state_id) values('$city','$state')";
     // exit;

    $exe = $obj->query("insert into city(city,state_id) values('$city','$state')");
    if($exe)
    {
                        ...
                        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            <form action="#" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                        ...
                                        <div class="col-lg-12">
                                            <input class=" form-control" id="place" name="city" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                        <div class="form-group ">
