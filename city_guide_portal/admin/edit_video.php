...
$id = $_GET['editid'];
$result = $obj->query("select * from videos where id='$id'");
...
if(isset($_POST['submit']))
{
    ...
    $exe=$obj->query ("update videos set video='$filename' where id='$id'");
    if($exe)
    {
                        ...
                        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            ...
                            <form action="#" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                        <label for="cname" class="control-label col-lg-3">Video</label>
                                        <div class="col-lg-12">
                                            <input class=" form-control" id="image" name="image" minlength="2" type="file" required="">
                                            <video controls="" width="150" height="150" autoplay="true" autobuffer="true">
