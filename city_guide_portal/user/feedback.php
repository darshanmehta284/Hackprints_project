...
if(isset($_POST['submit']))
{
   ...
   $exe=$obj->query ("insert into feedback(ratting,message,user_id)values('$ratting','$message','$id')");
                ...
                <div class="row">
                    <div class="col-lg-10" style="padding-left: 250px;">
                        <div class="section-title section-title-left mb-50">
                            <span class="sub-title">send Feedback</span>
                            ...
                            <div class="contact-form">
                                <form method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form_group">
                                                <textarea class="form_control" placeholder="Your Message" id="msg" name="msg" height="50"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form_group">
                                                <button class="main-btn" name="submit">Send Feedback</button>
                                            </div>
                                        </div>
