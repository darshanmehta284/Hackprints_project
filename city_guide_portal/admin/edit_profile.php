                        ...
                        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            ...
                            <form action="#" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                        ...
                                        <div class="col-lg-12">
                                            <input class=" form-control" id="place" name="city" minlength="2" type="text" required="" value="<?php echo $city->city;?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Contact</label>
                                        <div class="col-lg-12">
                                            <input class=" form-control" id="place" name="city" minlength="2" type="text" required="" value="<?php echo $city->city;?>">
                                        </div>
                                    </div>
