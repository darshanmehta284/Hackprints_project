...
$result1 = $obj->query("select * from inquiry");
                    ...
                    <table class="table" align="center">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" align="text-center">Fname</th>
                                <th scope="col" align="text-center">Lname</th>
                                <th scope="col" align="text-center">Phone</th>
                                <th scope="col" align="text-center">Email</th>
                                <th scope="col" align="text-center">Subject</th>
