...
$img = $obj->query("select images.id,images.place_id,images.image,place.place from images inner join place on images.place_id=place.id where place.id='$ide'");
                        ...
                        <div class="container emp-profile">
                            <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        {
                                        ?>
                                        <img src="upload/<?php echo $i->image;?>" height="200" width="200">
                                    ...
                                    <button><a href="more_image.php?placeid=<?php echo $i->place_id;?>">Add Images</a></button>
