...
$id = $_GET['editid'];
$result = $obj->query("select * from images where id='$id'");
...
if(isset($_POST['submit']))
{
    ...
    $exe=$obj->query ("update images set image='$filename' where ");
    if($exe)
    {
                            ...
                            <form action="#" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <img src="upload/<?php echo $myimage;?>" height="100" width="100">
                                        </div>
                                    </div>
